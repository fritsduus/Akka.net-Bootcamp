...
namespace ChartApp.Actors
{
    ...
    public class PerformanceCounterCoordinatorActor : ReceiveActor
    {
        ...
        /// <summary>
        /// Unsubscribing the <see cref="ChartingActor"/> to updates for <see cref="Counter"/>
        /// </summary>
        ...
        /// <summary>
        /// Methods for generating new instances of all <see cref="PerformanceCounter"/> we want to monitor
        /// </summary>
        ...
        public PerformanceCounterCoordinatorActor(IActorRef chartingActor, Dictionary<CounterType, IActorRef> counterActors)
        {
            ...
            Receive<Watch>(watch =>
            {
                ...
                {
                    IActorRef counterActor = Context.ActorOf(Props.Create(() => 
